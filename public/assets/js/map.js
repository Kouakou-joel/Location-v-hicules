google.maps.visualRefresh=true;var slider,infowindow=null;var bounds=new google.maps.LatLngBounds();var map,current=0;var locations=[{"id":"01","car_brand":"Ferrai","car_name":"Ferrari 458 MM Special","car_image":'assets/img/car-list-1.jpg',"reviews":"(4.0) 160","address":"Newyork, USA","km":"3.0m","amount":"$160","lat":53.470692,"lng":-2.220328,"icons":"'assets/img/icons/car-marker-01.svg'","profile_link":"listing-details.html","image":'assets/img/profiles/avatar-04.jpg'},{"id":"02","car_brand":"BMW","car_name":"BMW 640 XI Gran Turismo","car_image":'assets/img/car-list-2.jpg',"reviews":"(4.0) 165 ","address":"Pattaya, Thailand","km":"3.7m","amount":"$160","lat":53.469189,"lng":-2.199262,"icons":"'assets/img/icons/car-marker-01.svg'","profile_link":"listing-details.html","image":'assets/img/profiles/avatar-03.jpg'},{"id":"03","car_brand":"Ford","car_name":"Ford Mustang, Blue 2014","car_image":'assets/img/car-list-3.jpg',"reviews":"(4.0) 165 ","address":"Lasvegas, USA","km":"4.0m","amount":"$150","lat":53.468665,"lng":-2.189269,"icons":"default","profile_link":"listing-details.html","image":'assets/img/profiles/avatar-06.jpg'},{"id":"04","car_brand":"Audi","car_name":"Audi A3 2019 new","car_image":'assets/img/car-list-5.jpg',"reviews":"(4.0) 150 ","address":"Newyork, USA","km":"3.5m","amount":"$45","lat":53.463894,"lng":-2.177880,"icons":"default","profile_link":"listing-details.html","image":'assets/img/profiles/avatar-03.jpg'},{"id":"05","car_brand":"Ford","car_name":"Ford Mustang 4.0 AT","car_image":'assets/img/car-list-6.jpg',"reviews":"(4.0) 170  ","address":"Lasvegas, USA","km":"4.1m","amount":"$90","lat":53.466359,"lng":-2.213314,"icons":"default","profile_link":"listing-details.html","image":'assets/img/profiles/avatar-03.jpg'}];function show(){infowindow.close();if(!map.slide){return;}
...
function setInfo(marker){var content='<div class="listing-item" style="width: 100%; display: inline-block;">'+
...
function setMarkers(map,markers){for(var i=0;i<markers.length;i++){var item=markers[i];var latlng=new google.maps.LatLng(item.lat,item.lng);var marker=new google.maps.Marker({position:latlng,map:map,car_name:item.car_name,address:item.address,car_brand:item.car_brand,car_name:item.car_name,amount:item.amount,profile_link:item.profile_link,reviews:item.reviews,animation:google.maps.Animation.DROP,icons:item.icons,image:item.image,km:item.km,car_image:item.car_image});bounds.extend(marker.position);markers[i]=marker;google.maps.event.addListener(marker,"click",function(){setInfo(this);infowindow.open(map,this);window.clearTimeout(slider);});}
