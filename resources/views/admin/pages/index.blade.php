...
<div>
      ...
      <div class="col-auto">
        <div class="d-flex gap-3">
          <a class="btn btn-phoenix-primary" href="#!"
            ><span class="fa-solid fa-plus me-2"></span>New Package</a
          ><a class="btn btn-primary px-4 px-sm-11" href="#!"
            ><span class="fa-regular fa-calendar-days me-2"></span>Book
            Now</a
          >
        </div>
      </div>
   ...
   <div class="card p-4">
        ...
        <div class="card h-xxl-100">
          ...
          <div class="card-body">
            <div class="row align-items-center h-100 gy-5">
              ...
              >
                <div
                  class="echart-gross-profit mx-auto mt-3 mt-md-0 mt-xl-3 mt-xxl-0"
                  style="width: 250px; height: 250px"
                ></div>
              </div>
              <div
                class="col-12 col-md-auto col-xl-12 col-xxl-auto flex-1 h-md-100"
              >
                <div
                ...
                >
                  ...
                  >
                    <div class="d-flex gap-2">
                      <div
                        class="bullet-item bg-primary-light"
                        data-bs-theme="light"
                      ></div>
                      <div>
                        <h6 class="mb-0 text-body fw-semibold mb-2">
                          Flight
                        </h6>
                  ...
                  >
                    <div class="d-flex gap-2">
                      <div
                        class="bullet-item bg-info-light"
                        data-bs-theme="light"
                      ></div>
                      <div>
                        <h6 class="mb-0 text-body fw-semibold mb-2">
                  ...
                  >
                    <div class="d-flex gap-2">
                      <div
                        class="bullet-item bg-warning-light"
                        data-bs-theme="light"
                      ></div>
                      <div>
                        <h6 class="mb-0 text-body fw-semibold mb-2">
                  ...
                  >
                    <div class="d-flex gap-2">
                      <div
                        class="bullet-item bg-success-light"
                        data-bs-theme="light"
                      ></div>
                      <div>
                        <h6 class="mb-0 text-body fw-semibold mb-2">
      ...
      <div class="col-xl-7 col-xxl-5">
        <div class="card h-100">
          ...
          >
            ...
            <select
              class="form-select form-select-sm pe-9 w-auto mt-3 mt-sm-0 mt-xl-3 mt-xxl-0"
          ...
          <div class="card-body">
            <div
              class="echart-bookings"
              style="height: 100%; min-height: 322px; width: 100%"
            ></div>
          </div>
        </div>
      </div>
    ...
    <div
      class="mx-n4 px-4 mx-lg-n6 px-lg-6 pb-9 bg-body-emphasis border-top"
    >
      <div
      ...
      >
          ...
          <div class="col-auto flex-1">
            <div class="d-flex flex-between-center">
              <div class="d-flex align-items-center">
                ...
                <button class="btn btn-phoenix-secondary px-3 ms-2 me-3">
                  <span
              ...
              <div class="d-flex align-items-center">
                <div class="pagination d-none"></div>
                <p
                  class="mb-0 d-none d-md-block me-3 fw-semibold text-body text-nowrap"
                  data-list-info="data-list-info"
                ></p>
                <a
                  class="fw-semibold text-nowrap d-none d-sm-block"
                  href="#!"
                  data-list-view="*"
                  >View all<span
                    class="fas fa-angle-right ms-1"
                  ...
                  ></span></a
                ><a
                  class="fw-semibold d-none text-nowrap"
                  href="#!"
                  data-list-view="less"
                  >View Less</a
                ><button
                  class="btn btn-phoenix-primary px-3 me-1 ms-sm-4"
                  type="button"
                  title="Previous"
          ...
          <table class="table fs-9 mb-0 border-top border-translucent">
            <thead>
              <tr>
                ...
                <th
                  class="sort white-space-nowrap align-middle text-body-tertiary ps-0"
                  scope="col"
                  data-sort="flightNo"
                >
                  FLIGHTS NO.
                ...
                <th
                  class="sort align-middle text-body-tertiary"
                  scope="col"
                  data-sort="vendor"
                  style="width: 170px"
                >
                ...
                <th
                  class="sort text-start align-middle text-body-tertiary"
                  scope="col"
                  data-sort="weather"
                  style="width: 250px"
                >
                ...
                <th
                  class="sort text-end align-middle text-body-tertiary"
                  scope="col"
                  data-sort="status"
                ...
                <th
                  class="sort align-middle text-end text-body-tertiary"
                  scope="col"
                  data-sort="time"
            ...
            <tbody class="list" id="table-flights-body">
              <tr>
                ...
                <td class="align-middle flightNo ps-0">
                  <a class="fw-bold" href="#!">#24349</a>
                </td>
                <td class="align-middle vendor pe-5">
                  <a class="d-flex align-items-center gap-2" href="#!"
                    ><img
                      ...
                      width="32"
                    />
                    <h6 class="mb-0 text-primary fw-semibold text-nowrap">
                      Phoenix Firelines
                    </h6>
                  </a>
                </td>
                <td class="align-middle weather pe-5">
                  <div class="d-flex align-items-center">
                    <span
                      class="fa-solid fa-temperature-quarter me-2 text-info"
                    ></span>
                    <p class="mb-0 text-body-tertiary me-3">15°C</p>
                    <span
                      class="me-2 fa-solid fa-cloud-bolt text-body-tertiary"
                    ></span>
                ...
                <td class="align-middle route pe-5">
                  <div class="d-flex align-items-center gap-2">
                    <img
                      ...
                      width="16"
                    />
                    <p class="mb-0 fw-semibold text-bold">LAX</p>
                    <span
                      class="fa-solid fa-arrow-right text-body-tertiary mx-1"
                    ></span>
                    <p class="mb-0 fw-semibold text-bold">YVR</p>
                    <img
                ...
                <td class="align-middle destination pe-5 pe-xxl-7">
                  <div
                    class="progress overflow-visible"
                    role="progressbar"
                  ...
                  >
                    <div
                      class="progress-bar overflow-visible position-relative bg-info-light rounded"
                      style="width: 25%"
                    >
                      <span
                        class="fa-solid fa-plane text-info position-absolute end-0"
                      ></span>
                    </div>
                  </div>
                ...
                <td class="status align-middle text-end">
                  <span
                    class="badge badge-phoenix fs-10 badge-phoenix-warning"
                    >Delayed</span
                  >
                ...
                <td class="align-middle text-end time">
                  ...
                  >
                    <span class="fa-regular fa-clock text-body"> </span
                    ><span class="text-body fw-semibold">08:26 PM</span>
                  </div>
                ...
                <td class="align-middle text-end">
                  <div class="btn-reveal-trigger">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                      <a class="dropdown-item" href="#!">Track flight</a
              ...
              <tr>
                ...
                <td class="align-middle weather pe-5">
                  <div class="d-flex align-items-center">
                    <span
                      class="fa-solid fa-temperature-quarter me-2 text-danger"
                    ></span>
                    <p class="mb-0 text-body-tertiary me-3">28°C</p>
                    <span class="me-2 fa-solid fa-sun text-warning"></span>
                ...
                <td class="align-middle route pe-5">
                  <div class="d-flex align-items-center gap-2">
                    <img
                      ...
                      width="16"
                    />
                    <p class="mb-0 fw-semibold text-bold">EBJ</p>
                    <span
                      class="fa-solid fa-arrow-right text-body-tertiary mx-1"
                    ></span>
                    <p class="mb-0 fw-semibold text-bold">CDG</p>
                    <img
                ...
                <td class="align-middle text-end time">
                  ...
                  >
                    <span class="fa-regular fa-clock text-body"> </span
                    ><span class="text-body fw-semibold">07:23 PM</span>
                  </div>
                  <div class="d-flex justify-content-end gap-2">
                    <span
                      class="text-body"
                ...
                <td class="align-middle weather pe-5">
                  <div class="d-flex align-items-center">
                    <span
                      class="fa-solid fa-temperature-quarter me-2 text-info"
                    ></span>
                    <p class="mb-0 text-body-tertiary me-3">22°C</p>
                    <span class="me-2 fa-solid fa-wind text-info"></span>
                ...
                <td class="align-middle route pe-5">
                  <div class="d-flex align-items-center gap-2">
                    <img
                      ...
                      width="16"
                    />
                    <p class="mb-0 fw-semibold text-bold">GOT</p>
                    <span
                      class="fa-solid fa-arrow-right text-body-tertiary mx-1"
                    ></span>
                    <p class="mb-0 fw-semibold text-bold">BCN</p>
                    <img
                      src="../assets/img/country/usa.png"
                      alt=""
                      width="16"
              ...
              <tr>
                ...
                <td class="align-middle weather pe-5">
                  <div class="d-flex align-items-center">
                    <span
                      class="fa-solid fa-temperature-quarter me-2 text-info"
                    ></span>
                    <p class="mb-0 text-body-tertiary me-3">5°C</p>
                    <span
                      class="me-2 fa-solid fa-cloud-showers-heavy text-danger"
                    ></span>
                ...
                <td class="align-middle route pe-5">
                  <div class="d-flex align-items-center gap-2">
                    <img
                      ...
                      width="16"
                    />
                    <p class="mb-0 fw-semibold text-bold">DIA</p>
                    <span
                      class="fa-solid fa-arrow-right text-body-tertiary mx-1"
                    ></span>
                    <p class="mb-0 fw-semibold text-bold">OSL</p>
                    <img
                ...
                <td class="align-middle destination pe-5 pe-xxl-7">
                  ...
                  <div class="d-flex justify-content-between mt-2">
                    <p class="mb-0 fs-10 text-body-quaternary">
                      00 km, 00h:00m ago
                    </p>
                    <p class="mb-0 fs-10 text-body-quaternary">
                      00 km, in 00h:00m
        ...
        <div class="mapbox-container">
          <div class="position-relative">
            ...
            <div class="mapbox-control-btn flight-map-control-btn">
              <button class="zoomIn d-none d-md-block">
                <span class="fa-solid fa-plus"></span></button
              ><button class="zoomOut d-none d-md-block">
                <span class="fa-solid fa-minus"></span></button
              ><button class="fullScreen mt-md-3">
                <span
          ...
          <div
            class="position-absolute top-0 w-100 mt-3 mt-md-5 px-3 px-md-5 px-xl-7"
          >
            <div
              class="d-flex align-items-center bg-secondary overflow-hidden rounded-1"
              style="height: 46px"
            >
              <div
              ...
              >
                ...
                <h3 class="mb-0 fw-bold text-nowrap d-none d-md-block">
                  Live Tracking
                </h3>
              </div>
                ...
                >
                  <div class="swiper-wrapper swiper-continuous-autoplay">
                    <div class="swiper-slide w-auto">
                      <div class="d-flex align-items-center">
                        <h6
                          class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2"
                        >
                          1
                        </h6>
                        <img
                        ...
                        />
                        <h6
                          class="mb-0 text-white fw-semibold me-3 text-nowrap"
                        >
                          EK204 (AK98)
                        </h6>
                        <h6 class="mb-0 fw-semibold text-white">RIG</h6>
                        <span
                          class="fa-solid fa-plane text-primary mx-2"
                        ></span>
                        <h6
                          class="mb-0 fw-semibold text-white border-end pe-6"
                        >
                          LAX
                        </h6>
                      </div>
              ...
              <div class="col-auto">
                <table class="fs-9">
                  ...
                  <tr>
                    ...
                    <td>
                      <h6
                        class="mb-0 text-nowrap fw-semibold text-body-tertiary"
                      >
                        FF-SCA001
                      </h6>
                    </td>
              ...
              <div class="col-auto">
                <table class="fs-9">
                  ...
                  <tr>
                    ...
                    <td class="text-body-tertiary pe-2">:</td>
                    <td>
                      <h6 class="mb-0 text-nowrap fw-semibold text-primary">
                        YIP YIP
                      </h6>
                    </td>
                  </tr>
