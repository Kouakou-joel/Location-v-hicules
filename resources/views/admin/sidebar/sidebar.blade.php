        ...
        <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                    ...
                    <li class="nav-item">
                        <p class="navbar-vertical-label">Gestion des Administrateurs</p>
                        <hr class="navbar-vertical-line">
                        <div class="nav-item-wrapper">
                            <a class="nav-link dropdown-indicator label-1" href="#admin-management"
                                role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="admin-management">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="nav-link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path d="M12 13a4 4 0 0 0 0-8 4 4 0 0 0 0 8z"></path>
                                            <path d="M16 21v-2a4 4 0 0 0-8 0v2"></path>
                                            <path d="M16 21v-2a4 4 0 0 0-8 0v2"></path>
                                        </svg>
                                    </span>
                            ...
                            <div class="parent-wrapper label-1">
                                <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="admin-management">
                                    <li class="nav-item"><a class="nav-link" href="add-admin.html">
                                            <div class="d-flex align-items-center"><span class="nav-link-text">Ajouter Administrateur</span></div>
                                        </a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link" href="admins.html">
                                            <div class="d-flex align-items-center"><span class="nav-link-text">Liste des Administrateurs</span></div>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <li class="nav-item">
                        ...
                        <hr class="navbar-vertical-line">
                        <div class="nav-item-wrapper">
                            <a class="nav-link dropdown-indicator label-1" href="#client-management"
                                role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="client-management">
                                <div class="d-flex align-items-center">
                                    <div class="dropdown-indicator-icon-wrapper">
                                        <svg class="svg-inline--fa fa-caret-right dropdown-indicator-icon" aria-hidden="true"
                                            focusable="false" data-prefix="fas" data-icon="caret-right" role="img"
                    ...
                    <li class="nav-item">
                        <p class="navbar-vertical-label">Gestion des Rôles et Permissions</p>
                        <hr class="navbar-vertical-line">
                        <div class="nav-item-wrapper">
                            <a class="nav-link dropdown-indicator label-1" href="#role-management"
                                role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="role-management">
                                <div class="d-flex align-items-center">
                                    <div class="dropdown-indicator-icon-wrapper">
                                        <svg class="svg-inline--fa fa-caret-right dropdown-indicator-icon" aria-hidden="true"
                                            focusable="false" data-prefix="fas" data-icon="caret-right" role="img"
                                    ...
                                    <span class="nav-link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path d="M12 8V4a4 4 0 0 0-4-4A4 4 0 0 0 4 4v4"></path>
                                        </svg>
                                    </span>
                                    <span class="nav-link-text">Rôles et Permissions</span>
                                </div>
                            </a>
                            <div class="parent-wrapper label-1">
                                <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="role-management">
                                    <li class="nav-item"><a class="nav-link" href="roles.html">
                                            <div class="d-flex align-items-center"><span class="nav-link-text">Rôles</span></div>
                                        </a>
                                    </li>
                    ...
                    <li class="nav-item">
                        <p class="navbar-vertical-label">Gestion des Partenaires</p>
                        <hr class="navbar-vertical-line">
                        <div class="nav-item-wrapper">
                            <a class="nav-link dropdown-indicator label-1" href="#partner-management"
                                role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="partner-management">
                                <div class="d-flex align-items-center">
                                    <div class="dropdown-indicator-icon-wrapper">
                                        <svg class="svg-inline--fa fa-caret-right dropdown-indicator-icon" aria-hidden="true"
                                            focusable="false" data-prefix="fas" data-icon="caret-right" role="img"
                                    ...
                                    <span class="nav-link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                            <circle cx="12" cy="7" r="4"></circle>
                                            <path d="M16 21a4 4 0 0 0-8 0"></path>
                                        </svg>
                                    </span>
                            ...
                            <div class="parent-wrapper label-1">
                                <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="partner-management">
                                    <li class="nav-item"><a class="nav-link" href="add-partner.html">
                                            <div class="d-flex align-items-center"><span class="nav-link-text">Ajouter Partenaire</span></div>
                                        </a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link" href="edit-partner.html">
                                            <div class="d-flex align-items-center"><span class="nav-link-text">Modifier Partenaire</span></div>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <li class="nav-item">
                        <p class="navbar-vertical-label">Gestion des Réservations</p>
                        <hr class="navbar-vertical-line">
                        <div class="nav-item-wrapper">
                            <a class="nav-link dropdown-indicator label-1" href="#reservation-management"
                                role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="reservation-management">
                                <div class="d-flex align-items-center">
                                    <div class="dropdown-indicator-icon-wrapper">
                                        <svg class="svg-inline--fa fa-caret-right dropdown-indicator-icon" aria-hidden="true"
                                            focusable="false" data-prefix="fas" data-icon="caret-right" role="img"
                    ...
                    <li class="nav-item">
                        ...
                        <hr class="navbar-vertical-line">
                        <div class="nav-item-wrapper">
                            <a class="nav-link dropdown-indicator label-1" href="#payment-management"
                                role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="payment-management">
                                <div class="d-flex align-items-center">
                                    <div class="dropdown-indicator-icon-wrapper">
                                        <svg class="svg-inline--fa fa-caret-right dropdown-indicator-icon" aria-hidden="true"
                                            focusable="false" data-prefix="fas" data-icon="caret-right" role="img"
    ...
    <div class="navbar-vertical-footer">
        <button
            class="btn navbar-vertical-toggle border-0 fw-semibold w-100 white-space-nowrap d-flex align-items-center"><span
                ...
                class="uil uil-arrow-from-right fs-8"></span><span class="navbar-vertical-footer-text ms-2">Masquer
                le menu</span>
        </button>
    </div>
</nav>
        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
            <li class="nav-item">
                <div class="theme-control-toggle fa-icon-wait px-2"><input
                        ...
                        data-bs-title="Switch theme" style="height:32px;width:32px;"><svg
                            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="feather feather-sun icon">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" href="#" style="min-width: 2.25rem" role="button"
                    ...
                    data-bs-auto-close="outside"><span class="d-block" style="height:20px;width:20px;"><svg
                            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="feather feather-bell" style="height:20px;width:20px;">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-1 me-sm-3">
                                                                    ...
                                                                    <p
                                                                        class="fs-9 text-body-highlight mb-2 mb-sm-3 fw-normal">
                                                                        <span class="me-1 fs-10">👤</span>Tagged you
                                                                        in a comment.<span
                                                                            class="ms-2 text-body-quaternary text-opacity-75 fw-bold fs-10"></span>
                                                                    </p>
                                                                    <p class="text-body-secondary fs-9 mb-0"><svg
