...
@section('content')
<div class="breadcrumb-bar listing-page">
    <div class="container">
  ...
  <div class="section-search page-search mt-2">
    <div class="container">
                      ...
                      <div class="selectBox-cont">
                        ...
                        <div class="view-content">
                          <div class="viewall-One">
                            <label class="custom_check w-100">
                              <input type="checkbox" name="username" />
                              <span class="checkmark"></span> Hatchback
                              (123)
                            </label>
                            <label class="custom_check w-100">
                              <input type="checkbox" name="username" />
                        ...
                        <div class="blog-list-title">
                          <div class="title-bottom">
                            ...
                            <div class="address-info">
                              <h6>
                                <i class="feather-map-pin"></i>Amsterdam,
                                Netherland
                              </h6>
                            </div>
                            <div class="list-km">
                      ...
                      <div class="blog-list-head list-head-bottom d-flex">
                        <div class="blog-list-title">
                          <div class="title-bottom">
                            ...
                            <div class="address-info">
                              <h6>
                                <i class="feather-map-pin"></i>Pattaya,
                                Thailand
                              </h6>
                            </div>
                            <div class="list-km">
                      ...
                      <div class="blog-list-head list-head-bottom d-flex">
                        <div class="blog-list-title">
                          <div class="title-bottom">
                            ...
                            <div class="address-info">
                              <h6>
                                <i class="feather-map-pin"></i>Lasvegas, USA
                              </h6>
                            </div>
                            <div class="list-km">
                              <span class="km-count"
                      ...
                      <div class="blog-list-head list-head-bottom d-flex">
                        <div class="blog-list-title">
                          <div class="title-bottom">
                            ...
                            <div class="address-info">
                              <h6>
                                <i class="feather-map-pin"></i>Newyork, USA
                              </h6>
                            </div>
                            <div class="list-km">
                              <span class="km-count"
